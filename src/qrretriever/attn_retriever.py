...
class AttnBasedRetriever:
    ...
    def __init__(self,
        ...
        elif self.model_base_class.lower() in ['qwen3-4b-instruct-2507', 'qwen3-32b', 'qwen3-embedding-8b']:
    ...
    def get_prompt(self, query: str, docs: List[Dict]):
        ...
        elif self.model_base_class.lower() in ['qwen2.5-7b-instruct', 'qwen3-4b-instruct-2507', 'qwen3-32b', 'qwen3-embedding-8b']:
    ...
    def setup_config(self,
        ...
        if config_or_config_path is not None:
            ...
            if model_base_class is not None:
                ...
                elif model_base_class.lower() == 'qwen3-4b-instruct-2507':
                    config = load_config(CONFIG_DIR / 'Qwen3-4B-Instruct-2507_full_head.yaml')
                elif model_base_class.lower() == 'qwen3-32b':
                    config = load_config(CONFIG_DIR / 'Qwen3-32B_full_head.yaml')
                ...
                if 'llama-3.1-8b-instruct' in model_name_or_path.lower():
                    ...
                    config = load_config(CONFIG_DIR / 'Qwen2.5-7B-Instruct_full_head.yaml')
                elif 'qwen3-4b-instruct-2507' in model_name_or_path.lower():
                    config = load_config(CONFIG_DIR / 'Qwen3-4B-Instruct-2507_full_head.yaml')
                elif 'qwen3-32b' in model_name_or_path.lower():
                    config = load_config(CONFIG_DIR / 'Qwen3-32B_full_head.yaml')
